...
if (!empty($check1) || !empty($check2))
{
    ...
    echo '<a href="http://localhost/LeavePortal/RegisterNormalFaculty.php">Try Again</a>';
}
else
{
    $sql_insert="SELECT add_faculty_normal('$first_name','$last_name','$gender','$dept','$user_name','$pass_word')";//functional query
...
$sql_insert="INSERT INTO normal_faculty_details(faculty_id,department_name,login_name,password_hash,remaining_leaves) VALUES('$id','$dept','$user_name','$pass_word',0);";
$res=pg_query($db_connection,$sql_insert);
*/
/*
Notes : 
